...
import WithScale from "../animations/with-scale";
    ...
    >
      <input
        ...
        className={classNames(
          "flex rounded-md font-normal border outline-none border-gray-200 focus:border-blue-500 py-2 md:py-3 pl-3 pr-3 transition-all duration-200 text-gray-900 placeholder:text-gray-400 text-sm leading-6 appearance-none",
          className,
          {
            "!w-full": fullWidth,
